 ...
 */
function batch<Z, A extends unknown, R1, R2, R3, R4, R5, R6>(
	this: Z,
	...callbacks: [
		(this: Z, value: A) => R1,
		(this: Z, value: R1) => R2,
...
function batch<Z, A extends unknown, R1, R2, R3, R4, R5>(
	this: Z,
	...callbacks: [
		(this: Z, value: A) => R1,
		(this: Z, value: R1) => R2,
...
function batch<Z, A extends unknown, R1, R2, R3, R4>(
	this: Z,
	...callbacks: [
		(this: Z, value: A) => R1,
		(this: Z, value: R1) => R2,
...
function batch<Z, A extends unknown, R1, R2, R3>(
	this: Z,
	...callbacks: [(this: Z, value: A) => R1, (this: Z, value: R1) => R2, (this: Z, value: R2) => R3]
): (this: Z, value: A) => R3;
function batch<Z, A extends unknown, R1, R2>(
	this: Z,
	...callbacks: [(this: Z, value: A) => R1, (this: Z, value: R1) => R2]
): (this: Z, value: A) => R2;
function batch<Z, A extends unknown, R1>(this: Z, ...callbacks: [(this: Z, value: A) => R1]): (this: Z, value: A) => R1;
function batch<Z, A extends unknown, R1>(
	this: Z,
	...callbacks: [(this: Z, value: A) => R1]
): (this: Z, value: A) => R1 {
